...
S3_AUDIO_BASE_URL = "https://daily-podcast-stk.s3.us-east-005.backblazeb2.com"
...
fg.language('zh-TW')
fg.description("毎日陪你掌握財經、科技、AI、投資，輕鬆又有料的早晨 podcast！")
fg.logo(COVER_URL)
...
for folder in folders:
    ...
    audio_url = f"{S3_AUDIO_BASE_URL}/daily-podcast-stk-{folder}.mp3"
